...
import { elementRef, injectReactiveOrFail, mixedProp } from '@aerogel/core';
...
const props = defineProps({ placement: mixedProp<Placement>(String as PropType<Placement>, 'bottom-start') });
