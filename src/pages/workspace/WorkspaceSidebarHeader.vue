<template>
    <div class="group flex gap-2 px-4 pt-4">
        ...
        >
            ...
            <SelectInputOptions class="flex max-h-60 flex-col overflow-auto pb-10">
                <SelectInputOption
                ...
                <li class="invisible flex h-0 max-w-[calc(100vw-2rem)] pl-2 pr-3" aria-hidden="true">
                ...
                <SelectInputOption
                    :value="ADD_WORKSPACE"
                    class="absolute inset-x-0 bottom-0 p-0"
